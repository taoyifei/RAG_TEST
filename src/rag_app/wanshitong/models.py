...
class InternalModelValidationReport(FrozenModel):
    """单项真实 Provider 验证的脱敏结果。"""
    ...
    validation_mode: Literal["live", "mock"]
...
class InternalModelConfigurationReport(FrozenModel):
    ...
    validations: tuple[InternalModelValidationReport, ...] = Field(
