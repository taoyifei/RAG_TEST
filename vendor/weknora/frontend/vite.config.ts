...
const WANSHITONG_GATEWAY_AUTH = process.env.VITE_WANSHITONG_GATEWAY_AUTH === 'true'
...
export default defineConfig({
  base: WANSHITONG_GATEWAY_AUTH ? '/kb/admin/' : '/',
  define: {
  ...
  build: {
    ...
    rollupOptions: {
      input: WANSHITONG_GATEWAY_AUTH
        ? { main: resolve(__dirname, 'index.html') }
        : { main: resolve(__dirname, 'index.html'), embed: resolve(__dirname, 'embed.html') },
      output: {
        manualChunks(id) {
