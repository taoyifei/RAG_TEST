...
import { WANSHITONG_GATEWAY_AUTH, gatewayCsrfHeaders } from '@/config/wanshitongGateway'
...
export function testMultimodalFunction(testData: {
    ...
    return new Promise((resolve, reject) => {
        ...
        Object.assign(headers, gatewayCsrfHeaders('POST'));
        ...
        fetch(`${getApiBaseUrl()}/api/v1/initialization/multimodal/test`, {
            ...
            headers,
            body: formData,
            credentials: WANSHITONG_GATEWAY_AUTH ? 'include' : 'same-origin',
        })
