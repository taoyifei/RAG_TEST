  ...
  <div class="user-menu" :class="{ 'user-menu--collapsed': uiStore.sidebarCollapsed }" ref="menuRef">
    ...
    <Transition name="dropdown">
      <div v-if="menuVisible" class="user-dropdown" @click.stop>
        ...
        <div v-if="userName" class="dropdown-user-header" :class="{ 'is-clickable': !WANSHITONG_GATEWAY_AUTH }"
          :role="WANSHITONG_GATEWAY_AUTH ? undefined : 'button'" :tabindex="WANSHITONG_GATEWAY_AUTH ? -1 : 0"
          @click="!WANSHITONG_GATEWAY_AUTH && handleQuickNav('userprofile')"
          @keydown.enter.prevent="!WANSHITONG_GATEWAY_AUTH && handleQuickNav('userprofile')"
          @keydown.space.prevent="!WANSHITONG_GATEWAY_AUTH && handleQuickNav('userprofile')">
        ...
        <div class="menu-divider"></div>
        <div v-if="!WANSHITONG_GATEWAY_AUTH" class="menu-item" @click="openDocs">
        ...
        <div v-if="!WANSHITONG_GATEWAY_AUTH" class="menu-item" :title="$t('common.githubStarTip')" @click="openGithub">
