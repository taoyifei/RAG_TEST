# Legacy Industry/OCR：DOCX RAG smoke 离线发布 Quickstart

本目录只保留历史与迁移价值；V1 新部署使用根 `Dockerfile`、`compose.yaml` 和
`docs/public/quickstart.md`；旧完整参考为 `design/public/offline-build-and-server-deployment.md`，不得用于声明 P11 Ready。
